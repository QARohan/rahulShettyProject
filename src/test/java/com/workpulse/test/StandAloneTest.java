...
public class StandAloneTest {
	...
	public static void main(String[] args) {
		...
		driver.findElement(By.id("userEmail")).sendKeys("rohankg09@gmail.com");
		driver.findElement(By.id("userPassword")).sendKeys("Artis!@#123");
		...
		//ng-animating
		//wait.until(ExpectedConditions.invisibilityOfElementLocated(By.cssSelector(".ng-animating"))); // It's working but the performce issues 
